...
const ACCENT: [number, number, number] = [0.502, 0.569, 1.0]; // #8091FF
const ACCENT2: [number, number, number] = [0.761, 0.792, 1.0]; // #C2CAFF
const BASE: [number, number, number] = [0.098, 0.0, 0.416]; // #19006A
