...
export function EntryShell({
  ...
  useEffect(() => {
    // Design Hub: no cloud auth is wired up for this deployment yet, so
    // never force a signed-out visitor back to the Open Design Cloud
    // sign-in screen. Upstream behaviour (redirect to /onboarding on a
    // definitive signed-out AMR result) is intentionally disabled here.
    void amrLoggedIn;
    void view;
  }, [amrLoggedIn, view]);
