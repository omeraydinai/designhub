...
export const zhTW: Dict = {
  ...
  "homeHero.carousel.dhCorporateSite": "建立我們的機構官網",
  "homeHero.carousel.dhTransparencyDashboard": "建立預算透明度儀表板",
  "homeHero.carousel.dhDonationCampaign": "設計捐款活動頁面",
  "homeHero.carousel.dhEventRegistration": "建立活動報名頁面",
  "homeHero.skills": "技能",
  ...
  "fileViewer.publishSingleFileTitle": "發布單個檔案給所有人",
  ...
  'common.dismiss': '關閉',
  'campaign.deepseekV4Flash.headline': '這次，別省著用。DeepSeek V4 Flash 無限用。',
  'campaign.deepseekV4Flash.description': '落地頁、網站、簡報、圖片，無限做，做到滿意',
  'campaign.deepseekV4Flash.benefit': 'DeepSeek V4 Flash 無限使用',
  'campaign.deepseekV4Flash.timing': '8 月 6 日至 8 月 13 日，活動期間免費使用',
  'campaign.deepseekV4Flash.ruleSummary': '8 月 6 日至 8 月 13 日，付費用戶可在產品內免費使用；大規模盜刷等違規行為將暫停活動權益。',
  'campaign.deepseekV4Flash.windowLabel': '8 月 6 日—8 月 13 日',
  'campaign.deepseekV4Flash.weekFreeSuffix': '一週免費用',
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 Open Design 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。',
  ...
  'campaign.deepseekV4Flash.paid.eyebrow': '7 天免費開放',
  'campaign.deepseekV4Flash.paid.status': '已解鎖 · 8 月 6 日—8 月 13 日',
  ...
  'campaign.deepseekV4Flash.unpaid.status': '升級後可用 · 截止 8 月 13 日',
  'campaign.deepseekV4Flash.unpaid.cta': '升級方案，立即使用',
  'campaign.deepseekV4Flash.unpaid.modelBadge': '升級可用',
  'campaign.deepseekV4Flash.unpaid.tooltip': '活動期間訂閱付費方案後可用，統一於 8 月 13 日結束。',
  ...
  'campaign.deepseekV4Flash.workbenchBadge': 'DeepSeek V4無限免費用',
  'campaign.deepseekV4Flash.workbenchBadgeAria': 'DeepSeek V4 無限免費用，查看官網 Pricing',
};
