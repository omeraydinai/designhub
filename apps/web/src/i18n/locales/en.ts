...
export const en: Dict = {
  ...
  'homeHero.carousel.dhCorporateSite': "Build our corporate site",
  'homeHero.carousel.dhTransparencyDashboard': "Build a budget transparency dashboard",
  'homeHero.carousel.dhDonationCampaign': "Design a donation campaign page",
  'homeHero.carousel.dhEventRegistration': "Build an event registration page",
  ...
  'fileViewer.unpublishFile': 'Unpublish file',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'Publishing a public link needs a signed-in workspace. Sign in to Open Design Cloud, or use Deploy to publish this file.',
  'fileViewer.publishFileFailed': 'Could not publish this file. Please try again.',
  ...
  'campaign.deepseekV4Flash.headline': 'This time, don\'t hold back. Unlimited DeepSeek V4 Flash.',
  'campaign.deepseekV4Flash.description': 'Landing pages, sites, decks, and images — make as much as you need until it feels right.',
  'campaign.deepseekV4Flash.benefit': 'Unlimited DeepSeek V4 Flash',
  'campaign.deepseekV4Flash.timing': 'Aug 6–13: free to use during the campaign window',
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 6–13, paid users can use DeepSeek V4 Flash for free in Open Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 6–13',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'one week free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Open Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Open Design.',
  ...
  'campaign.deepseekV4Flash.paid.eyebrow': '7 days free',
  'campaign.deepseekV4Flash.paid.status': 'Unlocked · Aug 6–13',
  ...
  'campaign.deepseekV4Flash.unpaid.status': 'Upgrade to unlock · through Aug 13',
  'campaign.deepseekV4Flash.unpaid.cta': 'Upgrade and use',
  'campaign.deepseekV4Flash.unpaid.modelBadge': 'Upgrade to use',
  'campaign.deepseekV4Flash.unpaid.tooltip': 'Subscribe during the campaign window to use it free; ends Aug 13.',
  ...
  'campaign.deepseekV4Flash.workbenchBadge': 'DeepSeek V4 unlimited free',
  'campaign.deepseekV4Flash.workbenchBadgeAria': 'DeepSeek V4 unlimited free — view Pricing',
};
