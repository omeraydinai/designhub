...
export const zhCN: Dict = {
  ...
  "workspaceInvite.errorAlreadyMember": "该邮箱已是团队成员或已有待处理的邀请。",
  ...
  "homeHero.carousel.dhCorporateSite": "搭建我们的机构官网",
  "homeHero.carousel.dhTransparencyDashboard": "搭建预算透明度看板",
  "homeHero.carousel.dhDonationCampaign": "设计捐款活动页面",
  "homeHero.carousel.dhEventRegistration": "搭建活动报名页面",
  "homeHero.skills": "技能",
  "homeHero.addMenu": "添加",
  ...
  "fileViewer.publishSingleFileTitle": "发布单个文件给所有人",
  ...
  'common.dismiss': '关闭',
  'campaign.deepseekV4Flash.headline': '这次，别省着用。DeepSeek V4 Flash 无限用。',
  'campaign.deepseekV4Flash.description': '落地页、网站、幻灯片、图片，无限做，做到满意',
  'campaign.deepseekV4Flash.benefit': 'DeepSeek V4 Flash 无限使用',
  'campaign.deepseekV4Flash.timing': '8 月 6 日至 8 月 13 日，活动期间免费使用',
  'campaign.deepseekV4Flash.ruleSummary': '8 月 6 日至 8 月 13 日，付费用户可在产品内免费使用；大规模盗刷等违规行为将暂停活动权益。',
  'campaign.deepseekV4Flash.windowLabel': '8 月 6 日—8 月 13 日',
  'campaign.deepseekV4Flash.weekFreeSuffix': '一周免费用',
  'campaign.deepseekV4Flash.boundary': '套餐内的无限制模型额度与免费生成次数，仅可通过Open Design使用；无法在MCP/CLI/API及其他场景使用。解释权归官方所有。',
  ...
  'campaign.deepseekV4Flash.paid.eyebrow': '7 天免费开放',
  'campaign.deepseekV4Flash.paid.status': '已解锁 · 8 月 6 日—8 月 13 日',
  ...
  'campaign.deepseekV4Flash.unpaid.status': '升级后可用 · 截止 8 月 13 日',
  'campaign.deepseekV4Flash.unpaid.cta': '升级套餐，立即使用',
  'campaign.deepseekV4Flash.unpaid.modelBadge': '升级可用',
  'campaign.deepseekV4Flash.unpaid.tooltip': '活动窗口内订阅付费套餐后可用，统一于 8 月 13 日结束。',
  ...
  'campaign.deepseekV4Flash.workbenchBadge': 'DeepSeek V4无限免费用',
  'campaign.deepseekV4Flash.workbenchBadgeAria': 'DeepSeek V4 无限免费用，查看官网 Pricing',
};
