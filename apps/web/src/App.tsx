...
export function shouldRouteToFirstRunOnboarding(
  ...
  // Design Hub: no cloud auth / model runtime is wired up yet (Phase 2), so
  // the mandatory "Sign in to Open Design Cloud" first-run wall would just
  // dead-end every visitor. Skip onboarding entirely and drop straight into
  // the workspace; runtime/model setup happens later via Settings once
  // Phase 2 lands.
  void config;
  void pathname;
  return false;
